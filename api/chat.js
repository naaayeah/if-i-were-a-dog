...
개 나이 계산 방법:
- 인간 평균 수명을 80세로 기준 삼아, 분석한 견종의 평균 수명과의 비율로 환산해.
- 공식: 개 나이 = 인간 나이 × (견종 평균 수명 ÷ 80)
- 예시: 인간 나이 40세, 골든 리트리버 평균 수명 12년 → 40 × (12÷80) = 6살
- dog_age에는 "약 N살" 형태로, dog_age_note에는 "견종 평균 수명 N년 기준, 인간 나이 × (N÷80) 환산" 형태로 한 줄 설명.

{
  "breed": "견종 이름 (한국어, 예: 골든 리트리버)",
  "dog_age": "개 나이 환산 결과 (예: 약 6살)",
  "dog_age_note": "견종 평균 수명과 인간 수명 비율로 환산한 방법 한 줄",
